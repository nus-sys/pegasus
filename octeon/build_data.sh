...
#
# File version info: $Id: build_data.sh 69865 2012-02-11 02:16:39Z cchavva $
#
...
if model == "OCTEON_CN68XX":
   ...
   if len(sys.argv) == 1:
       ...
       if sys.argv[1] == "gmx2":
           ...
           incr = 16
           end_port = start_port + 49
       elif sys.argv[1] == "gmx3":
           start_port = 2816
           incr = 16
           end_port = start_port + 49
       elif sys.argv[1] == "gmx4":
           start_port = 3072
           incr = 16
           end_port = start_port + 49
   ...
   if model == "OCTEON_CN66XX" or model == "OCTEON_CN61XX":
      #print "argv [0] = %s len = %d" % (sys.argv[0], len(sys.argv))
      if len(sys.argv) == 1 or sys.argv[1] == "gmx1":
           port_range = (16, 20)
      else:
          if sys.argv[1] == "gmx0":
              port_range = (0, 4)
